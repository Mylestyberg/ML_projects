...
- I'm now going to try use DDPG instead of DQN, DQN is better to use with a finite space state, DDPG can be used for a continous state space like project cars.
